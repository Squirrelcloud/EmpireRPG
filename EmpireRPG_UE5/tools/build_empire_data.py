...
QUESTS = [
    ...
    },
    {
        ...
        "LoyaltyDeltaOnWin": 0,
        "LoyaltyDeltaOnLoss": 0,
        "DialogueStartId": "Marcus_Docks_Win_01",
        "UnlockAfter": "TakeoverDocks",
        "V0Active": True,
        "Summary": "Marcus wants the warehouse names and a decision on the river cameras.",
    },
    {
        "Name": "BetrayalVex",
        ...
        "UnlockAfter": "",
        "V0Active": True,
        "Summary": "Press Vex in the Hall while she is thin. Call her when armed. A tick can bring a buyer.",
    },
    {
        "Name": "BetrayalRico",
        "Title": "Rico walks",
        ...
        "UnlockAfter": "",
        "V0Active": True,
        "Summary": "Press Rico after an ego debrief. Call the corners when armed. A tick can bring a buyer.",
    },
    {
        "Name": "ReclaimMarket",
...
DIALOGUE = [
    ...
    line(
        "Marcus_Win_End",
        "Marcus",
        "That's the debrief. Watch the meters. The warehouse door is open if Neon isn't on fire.",
        ends=True,
    ),
    line(
        "Marcus_Loss_01",
    ...
    line(
        "Marcus_Loss_End",
        "Marcus",
        "That's the debrief. The Row is thin. Let the night run and watch control leak — or go take it back.",
        ends=True,
    ),
    line(
        "Rico_Docks_01",
        "Rico",
        "Warehouse door on the river is ajar. Two bodies minimum. Vex knows that door. Neon has to stay under a burn or we can't leave the Row.",
        a=(
            "I'll pick the crew.",
            "Rico_Docks_Pick",
            "",
        ...
        c=(
            "Ask Lena about the warehouse cameras.",
            "Rico_Docks_Lena",
            "Lena",
            2,
            0,
    ...
    line(
        "Rico_Docks_Pick",
        "Rico",
        "Two on the river, three if you can spare them. Marcus stays in the Hall.",
    ...
    line(
        "Rico_Docks_Vex",
        "Vex",
        "I grew up on that crane line. You put me on the door I won't sell it tonight.",
        a=("Open the roster.", "", "Rico", 1, 0, "", 0, "preselectVexRico"),
        ends=True,
    ),
    line(
        "Rico_Docks_Lena",
        "Lena",
        "Warehouse cameras dump to a clerk on the river, not Market. Cut the lights and the takeover heat dies. Leave them and the river stays loud.",
        a=(
            "Lena walks. Cut the lights if it comes to it.",
            "",
            "Lena",
        ...
        b=("Keep Lena off the river. I'll pick.", "", "", 0, 0, "", 0, "openAssignDocks"),
        ends=True,
    ),
    line(
        "Marcus_Docks_Win_01",
        "Marcus",
        "You took the warehouse. Takeover is noisy even when it holds. I want names. Who opened the door?",
        a=(
            "Vex opened it.",
            "Marcus_Docks_Win_Vex",
            "Vex",
            6,
            0,
            "",
        ...
        b=(
            "The crew took the warehouse.",
            "Marcus_Docks_Win_Crew",
            "",
            0,
            0,
            "",
    ...
    line(
        "Marcus_Docks_Win_Vex",
        "Marcus",
        "Her door, her name. Warehouse cameras still have us. Burn, pay the dock clerk, or leave the river cameras.",
        a=("Burn warehouse cameras.", "Marcus_Docks_Win_End", "Lena", 4, -10, "Docks", 0, "completeDocksDebrief"),
        b=("Pay the dock clerk.", "Marcus_Docks_Win_End", "Marcus", 6, -4, "Docks", 0, "completeDocksDebrief"),
        c=("Leave the river cameras.", "Marcus_Docks_Win_End", "Vex", 6, 8, "Docks", -4, "completeDocksDebrief"),
    ),
    line(
        "Marcus_Docks_Win_Crew",
        "Marcus",
        "Shared credit keeps them. Warehouse cameras still have the walk.",
        a=("Burn warehouse cameras.", "Marcus_Docks_Win_End", "Lena", 4, -10, "Docks", 0, "completeDocksDebrief"),
        b=("Pay the dock clerk.", "Marcus_Docks_Win_End", "Marcus", 6, -4, "Docks", 0, "completeDocksDebrief"),
        c=("Leave the river cameras.", "Marcus_Docks_Win_End", "Vex", 6, 8, "Docks", -4, "completeDocksDebrief"),
    ),
    line(
        "Marcus_Docks_Win_Ego",
        "Marcus",
        "They noticed. Loyalty thins when the Hall takes a river. Cameras still have us.",
        a=("Burn warehouse cameras.", "Marcus_Docks_Win_End", "Marcus", -2, -10, "Docks", 0, "completeDocksDebrief"),
        b=("Pay the dock clerk.", "Marcus_Docks_Win_End", "Marcus", 4, -4, "Docks", 0, "completeDocksDebrief"),
        c=("Leave the river cameras.", "Marcus_Docks_Win_End", "Vex", 8, 10, "Docks", -6, "completeDocksDebrief"),
    ),
    line(
        "Marcus_Docks_Win_End",
        "Marcus",
        "That's the river. Docks will leak if you never put bodies on it. Tick, or walk Neon if it's slipping.",
        ends=True,
    ),
    line(
        "Marcus_Docks_Loss_01",
        "Marcus",
        "The warehouse stayed shut. Heat on the river. I still need names.",
        a=(
            "Vex owns the miss.",
            "Marcus_Docks_Loss_Vex",
            "Vex",
            -6,
            4,
            "Docks",
    ...
    line(
        "Marcus_Docks_Loss_Vex",
        "Marcus",
        "She's already thin. Warehouse cameras still have the miss.",
        a=("Burn warehouse cameras.", "Marcus_Docks_Loss_End", "Lena", 3, -8, "Docks", 0, "completeDocksDebrief"),
        b=("Pay the dock clerk.", "Marcus_Docks_Loss_End", "Marcus", 5, -2, "Docks", 0, "completeDocksDebrief"),
        c=("Leave the river cameras.", "Marcus_Docks_Loss_End", "Vex", 8, 12, "Docks", -6, "completeDocksDebrief"),
    ),
    line(
        "Marcus_Docks_Loss_Crew",
        "Marcus",
        "Shared blame is cheaper than a scapegoat. River cameras still have the miss.",
        a=("Burn warehouse cameras.", "Marcus_Docks_Loss_End", "Lena", 3, -8, "Docks", 0, "completeDocksDebrief"),
        b=("Pay the dock clerk.", "Marcus_Docks_Loss_End", "Marcus", 5, -2, "Docks", 0, "completeDocksDebrief"),
        c=("Leave the river cameras.", "Marcus_Docks_Loss_End", "Vex", 8, 12, "Docks", -6, "completeDocksDebrief"),
    ),
    line(
        "Marcus_Docks_Loss_Ego",
        "Marcus",
        "Owning a river miss from the Hall is rare. They'll give you one more night.",
        a=("Burn warehouse cameras.", "Marcus_Docks_Loss_End", "Lena", 4, -8, "Docks", 0, "completeDocksDebrief"),
        b=("Pay the dock clerk.", "Marcus_Docks_Loss_End", "Marcus", 6, -2, "Docks", 0, "completeDocksDebrief"),
        c=("Leave the river cameras.", "Marcus_Docks_Loss_End", "Vex", 6, 12, "Docks", -6, "completeDocksDebrief"),
    ),
    line(
        "Marcus_Docks_Loss_End",
        "Marcus",
        "That's the debrief. The warehouse stayed shut. Tick or send them back.",
        ends=True,
    ),
    line(
        "Rico_Market_01",
    ...
    line(
        "Event_Vex_Press_01",
        "Vex",
        "I'm not at the table. I'm at the door. Buy me or I start looking at buyers.",
        a=("Sit. Your name on the river.", "Marcus_Vex_Held", "Vex", 16, 4, "Docks", 0, ""),
        b=("Then look.", "Marcus_Vex_Lean", "Vex", -10, 0, "", 0, ""),
        c=("Not tonight.", "", "", 0, 0, "", 0, "cancelQuest"),
    ),
    line(
        "Marcus_Vex_Held",
        "Marcus",
        "The river door is seated. Put her name on the next walk or this was rent.",
        ends=True,
    ),
    line(
        "Marcus_Vex_Lean",
        "Marcus",
        "She's closer to a buyer. Next tick can bring one. Call her before the night does.",
        ends=True,
    ),
    line(
        "Event_Vex_01",
        "Vex",
        "I have a buyer for the river. Last number. Buy me, cut me, or I walk it tonight.",
        a=("Buy the door.", "Marcus_Vex_Held", "Vex", 20, 8, "Docks", 0, ""),
        b=("Cut her.", "Event_Vex_Cut", "Vex", 0, 12, "Docks", -16, "vexBetrayed"),
        c=("Let the sale.", "Event_Vex_Sale", "Vex", 0, 18, "Docks", -10, "vexBetrayed"),
    ),
    line(
        "Event_Vex_Cut",
        "Vex",
        "I sold it because you kept me thin. Keep the warehouse. I'm gone.",
        a=("Marcus.", "Marcus_Vex_Gone", "", 0, 0, "", 0, ""),
    ),
    line(
        "Event_Vex_Sale",
        "Vex",
        "Clerk already has the route. You can burn cameras. You can't unsell it.",
        a=("Marcus.", "Marcus_Vex_Gone", "", 0, 0, "", 0, ""),
    ),
    line(
        "Marcus_Vex_Gone",
        "Marcus",
        "The river door is empty. Names still at the table need a line.",
        a=("Credit who stayed.", "Marcus_Vex_End", "", 0, 0, "", 0, "creditRemaining"),
        b=("This one is on me.", "Marcus_Vex_End", "Marcus", -2, 0, "", 0, ""),
        c=("Burn warehouse cameras.", "Marcus_Vex_End", "Lena", 3, -8, "Docks", 0, ""),
    ),
    line(
        "Marcus_Vex_End",
        "Marcus",
        "That's the door. Tick, walk Neon, or take the river without her.",
        ends=True,
    ),
    line(
        "Rico_Table_01",
        "Rico",
        "You put your name on the hold. The corners heard it from the Hall, not from me. Buy them back or they're yours.",
        a=("Sit. The corners stay yours.", "Marcus_Rico_Held", "Rico", 16, 4, "NeonRow", 0, "ricoNamed"),
        b=("They're my corners.", "Marcus_Rico_Word", "", 0, 4, "NeonRow", 0, "ricoWord"),
        c=("Not tonight.", "", "", 0, 0, "", 0, "cancelQuest"),
    ),
    line(
        "Marcus_Rico_Word",
        "Marcus",
        "He heard it twice. He's thin. Press the corners before a night does.",
        ends=True,
    ),
    line(
        "Event_Rico_Press_01",
        "Rico",
        "You keep putting your name on the hold. Mine's getting thin. Buy the corners or I walk.",
        a=("Sit. The corners stay yours.", "Marcus_Rico_Held", "Rico", 16, 4, "NeonRow", 0, ""),
        b=("Then walk.", "Marcus_Rico_Lean", "Rico", -10, 0, "", 0, ""),
        c=("Not tonight.", "", "", 0, 0, "", 0, "cancelQuest"),
    ),
    line(
        "Marcus_Rico_Held",
        "Marcus",
        "The corners are seated. Don't ego him twice in a row.",
        ends=True,
    ),
    line(
        "Marcus_Rico_Lean",
        "Marcus",
        "He's closer to walking. Call the corners before a tick does.",
        ends=True,
    ),
    line(
        "Event_Rico_01",
        "Rico",
        "Hall keys. A buyer. Last number. Buy me, cut me, or I leave the note.",
        a=("Buy the corners.", "Marcus_Rico_Held", "Rico", 20, 6, "NeonRow", 0, ""),
        b=("Cut him.", "Event_Rico_Cut", "Rico", 0, 8, "Hall", -10, "ricoBetrayed"),
        c=("Let him walk.", "Event_Rico_Sale", "Rico", 0, 12, "NeonRow", -8, "ricoBetrayed"),
    ),
    line(
        "Event_Rico_Cut",
        "Rico",
        "You wanted the name on the door. Keep it. I'm off the board.",
        a=("Marcus.", "Marcus_Rico_Gone", "", 0, 0, "", 0, ""),
    ),
    line(
        "Event_Rico_Sale",
        "Rico",
        "Keys are already gone. The corners will leak without me.",
        a=("Marcus.", "Marcus_Rico_Gone", "", 0, 0, "", 0, ""),
    ),
    line(
        "Marcus_Rico_Gone",
        "Marcus",
        "The corners are empty. Ray can hold a mouth. He can't hold two.",
        a=("Credit who stayed.", "Marcus_Rico_End", "", 0, 0, "", 0, "creditRemaining"),
        b=("This one is on me.", "Marcus_Rico_End", "Marcus", -2, 0, "", 0, ""),
        c=("Burn the footage.", "Marcus_Rico_End", "Lena", 3, -8, "NeonRow", 0, ""),
    ),
    line(
        "Marcus_Rico_End",
        "Marcus",
        "That's the corners. The Hall still stands. Watch the leak.",
        ends=True,
    ),
    line(
        "Marcus_Morning_01",
        "Marcus",
        "Morning. The take is on the books. Bank it, pay who stayed, or burn leftover footage.",
        a=("Bank it.", "Marcus_Morning_End", "Marcus", 2, 0, "", 0, ""),
        b=("Pay who stayed.", "Marcus_Morning_End", "", 0, 0, "", 0, "morningPayCrew"),
        c=("Burn leftover footage.", "Marcus_Morning_End", "Lena", 2, -8, "NeonRow", 0, ""),
    ),
    line(
        "Marcus_Morning_End",
        "Marcus",
        "That's the books. Walk Neon, take the river, or let the night run again.",
        ends=True,
    ),
]
...
SIM_RULES = {
    ...
    "v0Quests": ["DefendNeonRow", "DebriefMarcus", "TakeoverDocks", "DebriefDocks"],
}
